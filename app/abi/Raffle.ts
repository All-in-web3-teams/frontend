export const Raffle = [
  ...
  { type: 'function', name: 's_vrfCoordinator', inputs: [], outputs: [{ name: '', type: 'address', internalType: 'contract IVRFCoordinatorV2Plus' }], stateMutability: 'view' },
  { type: 'function', name: 'setCoordinator', inputs: [{ name: '_vrfCoordinator', type: 'address', internalType: 'address' }], outputs: [], stateMutability: 'nonpayable' },
  { type: 'function', name: 'transferOwnership', inputs: [{ name: 'to', type: 'address', internalType: 'address' }], outputs: [], stateMutability: 'nonpayable' },
  { type: 'event', name: 'CoordinatorSet', inputs: [{ name: 'vrfCoordinator', type: 'address', indexed: false, internalType: 'address' }], anonymous: false },
